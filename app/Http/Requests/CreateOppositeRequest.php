...
class CreateOppositeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'opposite_one_image' => 'required|image|mimes:jpg,jpeg,png|max:300',
            'opposite_two_image' => 'required|image|mimes:jpg,jpeg,png|max:300',
        ];
    }
