...
class UpdateQuantitiyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'quantitiy_one_image' => 'nullable|image|mimes:jpg,jpeg,png|max:300',
            'quantitiy_two_image' => 'nullable|image|mimes:jpg,jpeg,png|max:300',
        ];
    }
