...
class CreateSenseRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'sense_one_image' => 'required|image|mimes:jpg,jpeg,png|max:300',
            'sense_two_image' => 'required|image|mimes:jpg,jpeg,png|max:300',
        ];
    }
