...
class CreateShapeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'shape_name' => 'required|min:2|max:100',
            'shape_text' => 'required|min:2|max:100',
            'shape_two_text' => 'nullable|min:2|max:100',
            'shape_image' => 'required|image|mimes:jpg,jpeg,png|max:300',
